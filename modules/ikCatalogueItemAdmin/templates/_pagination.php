<div class="sf_admin_pagination">
  <a href="<?php echo url_for('@catalogue_item') ?>?page=1<?php echo $category?'&category='.$category:'' ?>">
  ...
  <a href="<?php echo url_for('@catalogue_item') ?>?page=<?php echo $pager->getPreviousPage() ?><?php echo $category?'&category='.$category:'' ?>">
  ...
  <?php foreach ($pager->getLinks() as $page): ?>
    <?php if ($page == $pager->getPage()): ?>
      <?php echo $page ?>
    <?php else: ?>
      <a href="<?php echo url_for('@catalogue_item') ?>?page=<?php echo $page ?><?php echo $category?'&category='.$category:'' ?>"><?php echo $page ?></a>
    <?php endif; ?>
  <?php endforeach; ?>

  <a href="<?php echo url_for('@catalogue_item') ?>?page=<?php echo $pager->getNextPage() ?><?php echo $category?'&category='.$category:'' ?>">
  ...
  <a href="<?php echo url_for('@catalogue_item') ?>?page=<?php echo $pager->getLastPage() ?><?php echo $category?'&category='.$category:'' ?>">
